...
the notebook "1_simplot_generator" creates simplot which is useful to test DNA sequences for recombination events. This script shows the same results as the RAT tool[1] and simplot[2].  
