...
"""
import pytest
from recan.recan import _pdistance, simgen
...
def test_pdistance():
    ...
    assert _pdistance("----------", "----------") == None # comment assertion error to test this
    assert _pdistance("A-A-A-A-A-", "-A-A-A-A-A") == None # comment assertion error to test this
